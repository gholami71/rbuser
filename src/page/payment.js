                    ...
                    <>
                        ...
                        <div className="pay-box">
                            ...
                            <button onClick={checkPayment}>اعمال کد تخفیف</button>
                            {
                                ...
                                <div className="alrt">
                                    <h6>توجه</h6>
                                    <p>با توجه به اینکه شما در حال ارتقا سطح اشتراک خود هستید، بعد از تکمیل فرایند خرید، زمان اشتراک قبلی شما از بین خواهد رفت و اشتراک جدید جایگزین آن خواهد شد.</p>
                                </div>
                                :null
                            }
